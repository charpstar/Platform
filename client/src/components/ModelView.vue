<template>
    <div id="item">
        ...
        <div class="row" id="itemsrow">
            <model-viewer :src="model.androidmodel" auto-rotate camera-controls id="modelView"></model-viewer>
            <div class="column">
                <h2>{{model.name}}</h2>
                <table id="itemTable">
                    <tr>
                        ...
                        <td>{{model.status}}</td>
                        <td>
                            <i class="material-icons">{{model.statusicon}}</i>
                        </td>
                    </tr>
                ...
                <comments :account="account" :comments="model.comments" @comment="sendComment" :review="true"/>
            </div>
        </div>
